...
# AP3B: Clean hold timing closure
...
report_checks -group_count 10 -endpoint_count 1

puts "=================== TOP 50 REG2REG PATHS ==================="
report_checks -path_delay max -from [all_registers] -to [all_registers] -endpoint_count 50 -format full_clock_expanded > "$rpt_dir/closable_timing_reg2reg.rpt"
report_checks -path_delay max -from [all_registers] -to [all_registers] -endpoint_count 5 -format full_clock_expanded

puts "=================== TOP 10 IN2REG PATHS ==================="
report_checks -path_delay max -from $non_clock_inputs -to [all_registers] -endpoint_count 10 -format full_clock_expanded > "$rpt_dir/closable_timing_in2reg.rpt"
report_checks -path_delay max -from $non_clock_inputs -to [all_registers] -endpoint_count 5 -format full_clock_expanded

puts "=================== TOP 10 REG2OUT PATHS ==================="
report_checks -path_delay max -from [all_registers] -to $all_outputs_list -endpoint_count 10 -format full_clock_expanded > "$rpt_dir/closable_timing_reg2out.rpt"

puts "=================== TOP 10 IN2OUT PATHS ==================="
report_checks -path_delay max -from $non_clock_inputs -to $all_outputs_list -endpoint_count 10 -format full_clock_expanded > "$rpt_dir/closable_timing_in2out.rpt"

puts "=================== TOP 10 HOLD REG2REG PATHS ==================="
report_checks -path_delay min -from [all_registers] -to [all_registers] -endpoint_count 10 -format full_clock_expanded > "$rpt_dir/closable_hold_reg2reg.rpt"
report_checks -path_delay min -from [all_registers] -to [all_registers] -endpoint_count 5 -format full_clock_expanded
