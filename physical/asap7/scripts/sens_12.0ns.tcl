...
create_clock -name core_clk -period 12000.0 -waveform [list 0 [expr 12000.0 / 2.0]] [get_ports clk]
...
set_input_delay [expr 0.2 * 12000.0] -clock core_clk $non_clock_inputs
set_output_delay [expr 0.2 * 12000.0] -clock core_clk $all_outputs_list

puts "=== REPORTING PATH _387041_ -> _388327_ FOR T = 12.0 ns ==="
